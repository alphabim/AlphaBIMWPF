...
using MaterialDesignThemes.Wpf;using MahApps.Metro;
...
namespace AlphaBIM
{
    ...
    /// </summary>
    public partial class Scope2Window : INotifyPropertyChanged
    {
        ...
        {
            Height = MainGrid.ActualHeight + 55;
            Width = MainGrid.ActualWidth + 15;
        }
    }
}
